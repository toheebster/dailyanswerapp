...
export default class AgendaView extends Component {
  ...
  onLayout(event) {
    ...
    this.forceUpdate();
    this.calendar.scrollToDay(this.state.selectedDay.clone(), this.calendarOffset(), true); // toheeb have header scroll to day upon reload .. make sure to pass in true and not false
  }
