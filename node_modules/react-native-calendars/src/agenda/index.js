...
const HEADER_HEIGHT = 120; // toheeb header height and calendar touch drag slide
...
export default class AgendaView extends Component {
  ...
  onLayout(event) {
    ...
    // toheeb have header scroll to day upon reload .. make sure to pass in true and not false
    setTimeout(() => this.calendar.scrollToDay(this.state.selectedDay.clone(), this.calendarOffset(), true), 1000);
    this.calendar.scrollToDay(this.state.selectedDay.clone(), -2000, true);
    this.forceUpdate();
  }
